    ...
    <div class="card mb-4 border-0 shadow">
      <div class="row g-0 p-3 align-items-center">
        ...
        <div class="col-md-5 px-lg-3 px-md-3 px-0">
          ...
          <div class="features mb-3">
             <h6 class="mb-1">Features</h6>
              <span class="badge rounded-pill text-bg-light text-wrap">2 Bedrooms</span>
        ...
        <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
         <h6 class="mb-1">Rp.200.000/night</h6>
        ...
        <div class="col-md-5 px-lg-3 px-md-3 px-0">
          ...
          <div class="features mb-3">
             <h6 class="mb-1">Features</h6>
              <span class="badge rounded-pill text-bg-light text-wrap">2 Bedrooms</span>
              <span class="badge rounded-pill text-bg-light text-wrap">1 Bathrooms</span>
              <span class="badge rounded-pill text-bg-light text-wrap">1 Wardrobe</span>
          </div>
          <div class="facilities mb-3">
            <h6 class="mb-1">Facilities</h6>
            <span class="badge rounded-pill text-bg-light text-wrap">Wi-Fi</span>
