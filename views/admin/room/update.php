    ...
    <div class="row">
        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            ...
            <div class="container mt-5">
                ...
                <?php else: ?>
                    <form method="post" action="/admin/room/edit/<?= $room->id ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" required><?php echo $room->description ?></textarea>
                        </div>
                        <div class="mb-3">
